...
// This file (utils.js) is like a toolbox that provides a variety of utility functions to help with different tasks throughout the project. Here's what it does in simple terms:

// Handles Strings and HTML: It includes tools to split, modify, or style HTML content.
// Network Information: It can find the network interfaces and their details (like IP addresses) on the machine.
// Date and Time Tools: It helps with things like formatting dates, calculating the day of the year, or splitting a time range into smaller parts.
// Checking Data: It checks if something is empty, null, undefined, a number, or even a plain object.
// JSON Handling: It safely parses JSON strings without crashing.
// Splitting and Chunking: It splits arrays or time ranges into smaller chunks for easier processing.
// Merging Data: It combines data from two objects.
// Retention Policy: It calculates how far back to keep records based on a retention rule (like 1 day, 7 days, etc.).
// In summary, this file contains general-purpose helpers that make coding easier by reusing common tasks instead of rewriting them repeatedly.
